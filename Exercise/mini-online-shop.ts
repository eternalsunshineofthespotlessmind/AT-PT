...
const apple: Product = { name: 'Apple', price: 2000, category: 'food' };
...
// add function filterByCategory - receive products and category as parameters and filer the produts by given category
// add fucntion calculateTotalPrice - receive customer data and combine all products price
// customer.cart[0].price
// customer.cart[1].price
// ...
// total /let, const of every price/
export {};
